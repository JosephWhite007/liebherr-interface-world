	...
	public static function maybe_enqueue(): void {
		...
		wp_localize_script( self::HANDLE, 'liwIw', [
			...
			'i18n' => [
				...
				'proto_title'   => __( 'Nutzungs- und Kostenprotokoll', 'liebherr-interface-world' ),
				'proto_intro'   => __( 'Prototyp – Beispieldaten, keine echte Abrechnung. Zeiten in UTC.', 'liebherr-interface-world' ),
				'proto_session' => __( 'Sitzung', 'liebherr-interface-world' ),
				'proto_status'  => __( 'Status', 'liebherr-interface-world' ),
				'proto_start'   => __( 'Start', 'liebherr-interface-world' ),
				'proto_end'     => __( 'Ende', 'liebherr-interface-world' ),
				'proto_active'  => __( 'Aktive Zeit', 'liebherr-interface-world' ),
				'proto_base'    => __( 'Basiskosten', 'liebherr-interface-world' ),
				'proto_budget'  => __( 'Budget', 'liebherr-interface-world' ),
				'proto_events'  => __( 'Ereignisse', 'liebherr-interface-world' ),
				'proto_seq'     => __( 'Nr.', 'liebherr-interface-world' ),
				'proto_time'    => __( 'Zeitpunkt (UTC)', 'liebherr-interface-world' ),
				'proto_event'   => __( 'Ereignis', 'liebherr-interface-world' ),
				'proto_intact'  => __( 'Protokollkette unverändert (integer)', 'liebherr-interface-world' ),
