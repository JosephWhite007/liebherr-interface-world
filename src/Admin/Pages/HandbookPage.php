...
final class HandbookPage {
	...
	public static function render(): void {
		...
		<div class="wrap">
			...
			<p><?php esc_html_e( 'Grafiken LP-07/LP-08 einbetten (seit alpha.15): im Abschnitts-Editor einen Shortcode-Block mit [liw_graphic name="data-model"] (Datenmodell, LP-07) bzw. [liw_graphic name="process-worlds"] (Prozesswelten, LP-08) einfügen; optional caption="…" für eine Bildunterschrift. Die Grafiken werden inline eingebettet und übernehmen die Farben des zentralen Design Systems. Andere Werte für name werden aus Sicherheitsgründen ignoriert (feste Whitelist, keine Dateipfade).', 'liebherr-interface-world' ); ?></p>
