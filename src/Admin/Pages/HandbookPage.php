...
final class HandbookPage {
	...
	public static function render(): void {
		...
		<div class="wrap">
			...
			<h2><?php esc_html_e( 'Die elf Bereiche im Überblick', 'liebherr-interface-world' ); ?></h2>
			...
			<h3><?php esc_html_e( '11. Landingpage im Frontend – Shortcodes & Design System', 'liebherr-interface-world' ); ?></h3>
