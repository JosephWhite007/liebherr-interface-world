 ...
 * jeder fachlichen Erweiterung. Deckt seit alpha.10 alle sechs Boards sowie die beiden
 * Frontend-Shortcodes und die neuen Nachvollziehbarkeits-Reiter (Programmierlogbuch,
 * To-Dos) ab.
 *
...
final class HandbookPage {
	...
	public static function render(): void {
		...
		<div class="wrap">
			...
			<h2><?php esc_html_e( 'Die sechs Bereiche im Überblick', 'liebherr-interface-world' ); ?></h2>
			...
			<h3><?php esc_html_e( '2. Simulation Board (§17 – Magic Cube)', 'liebherr-interface-world' ); ?></h3>
			...
			<h3><?php esc_html_e( '3. World Connections Map – Datenpflege (§17/LP-06)', 'liebherr-interface-world' ); ?></h3>
			...
			<h3><?php esc_html_e( '4. Onboarding – Partneranfragen (§22)', 'liebherr-interface-world' ); ?></h3>
			...
			<h3><?php esc_html_e( '5. Media Board (§18 – Assets & Freigabe)', 'liebherr-interface-world' ); ?></h3>
			...
			<h3><?php esc_html_e( '6. World Connections Map – Frontend & Design System', 'liebherr-interface-world' ); ?></h3>
