...
final class HandbookPage {
	...
	public static function render(): void {
		...
		<div class="wrap">
			...
			<h2><?php esc_html_e( 'Die neun Bereiche im Überblick', 'liebherr-interface-world' ); ?></h2>
			...
			<h3><?php esc_html_e( '9. Landingpage im Frontend – Shortcodes & Design System', 'liebherr-interface-world' ); ?></h3>
