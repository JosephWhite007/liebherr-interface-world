...
final class LocalIntelligenceContent {
	...
	/**
	 * Standard-Nutzungsbedingungen (Abschnitte 5.1–5.8), die im Intro-Fenster angezeigt werden.
	 * Schlichtes Markup: `## Abschnitt`, `- Aufzählung`, `1. Nummerierung`, Leerzeile = neuer Absatz.
	 * Reiner Text (übersteht `sanitize_textarea_field`); IntroOverlay rendert ihn escaped zu HTML.
	 * Redaktionell im Local-Intelligence-Board überschreibbar.
	 */
	public static function default_terms(): string {
		return implode( "\n", [
			'## 5.1 Prototypstatus, Beispieldaten und Vertraulichkeit',
			'Liebherr Local Intelligence ist eine interne, zugangsgeschützte Plattform. Soweit die Plattform noch nicht offiziell für den Produktivbetrieb freigegeben wurde, wird sie im Prototyp-, Demonstrations- oder Testbetrieb bereitgestellt. Bis zur offiziellen Freigabe gelten die jeweils beim Zugang zur Plattform angezeigten vorläufigen Nutzungsbedingungen.',
			'Die innerhalb der Plattform dargestellten Inhalte, Szenarien, Kennzahlen, Simulationen, Prognosen und Ergebnisse können ganz oder teilweise auf Beispiel-, Test- oder Simulationsdaten beruhen. Sie dürfen ohne gesonderte fachliche Freigabe nicht als verbindliche Unternehmens-, Produkt-, Finanzierungs-, Vertriebs- oder Planungsdaten verwendet werden.',
			'Sämtliche nicht öffentlich zugänglichen Inhalte der Plattform sind vertraulich zu behandeln. Sie dürfen ausschließlich für den jeweils freigegebenen internen Zweck genutzt und nicht ohne vorherige Genehmigung an unberechtigte Dritte weitergegeben, veröffentlicht, vervielfältigt oder außerhalb der freigegebenen Systemumgebung verarbeitet werden.',
			'Ergänzend gelten das Impressum, die Datenschutzhinweise sowie gegebenenfalls weitere beim Zugang angezeigte Vertrags- und Sicherheitsbestimmungen.',
			'',
			'## 5.2 Lokale Speicherung auf dem Endgerät',
			'Zur sicheren Bereitstellung, Beschleunigung und funktionalen Verbesserung der Plattform können innerhalb eines ausdrücklich freigegebenen Speichergrundbudgets Daten auf dem Endgerät des Anwenders gespeichert werden.',
			'Hierzu können insbesondere folgende Daten gehören:',
			'- persönliche und technische Einstellungen;',
			'- Sitzungs- und Authentifizierungsinformationen;',
			'- temporäre Zwischenergebnisse;',
			'- Cache-Daten;',
			'- Simulations- und Bearbeitungsstände;',
			'- technisch erforderliche Protokoll- und Statusinformationen.',
			'Vor dem erstmaligen Eintritt in die Plattform werden Zweck, Art, Dauer und voraussichtlicher Umfang der lokalen Speicherung sowie die Höhe des vorgesehenen Speichergrundbudgets angezeigt.',
			'Eine Überschreitung des freigegebenen Speichergrundbudgets erfolgt nicht automatisch. Benötigt eine Funktion zusätzlichen Speicherplatz, wird dem Anwender vorab eine gesonderte Anfrage angezeigt. Diese muss den Zweck und den zusätzlich benötigten Speicherumfang verständlich ausweisen. Der Anwender kann die zusätzliche Speicherung freigeben oder ablehnen.',
			'Die Ablehnung zusätzlichen Speicherplatzes darf grundsätzlich nur diejenige Funktion einschränken, für deren ordnungsgemäße Ausführung dieser Speicher objektiv erforderlich ist.',
			'Speicherungen oder Zugriffe, die für den Betrieb der Plattform technisch nicht erforderlich sind, werden gesondert behandelt. Eine hierfür erforderliche Einwilligung muss freiwillig, informiert und jederzeit mit Wirkung für die Zukunft widerrufbar sein.',
			'Die Plattform stellt eine Funktion bereit, mit der lokal gespeicherte Plattformdaten angezeigt und – soweit keine gesetzlichen, vertraglichen oder sicherheitstechnischen Gründe entgegenstehen – gelöscht werden können.',
			'',
			'## 5.3 Beginn und Ende der kostenpflichtigen Nutzungszeit',
			'Eine kostenpflichtige aktive Sitzung beginnt ausschließlich, wenn',
			'1. der persönliche oder sitzungsbezogene Bestätigungscode erfolgreich geprüft wurde und',
			'2. der Anwender anschließend die eindeutig als kostenpflichtig gekennzeichnete Eintrittsschaltfläche aktiv betätigt hat.',
			'Vor dieser Bestätigung entstehen keine zeitabhängigen Nutzungsgebühren.',
			'Während der aktiven Nutzung von Liebherr Local Intelligence wird die laufende Sitzungs- beziehungsweise Nutzungszeit für den Anwender sichtbar angezeigt.',
			'Die aktive Sitzung endet durch:',
			'- die Betätigung der Funktion „Sitzung beenden“;',
			'- eine ordnungsgemäße Abmeldung;',
			'- den Ablauf einer administrativ festgelegten Inaktivitätsfrist;',
			'- eine technisch eindeutig festgestellte Beendigung der Sitzung;',
			'- eine administrative Beendigung aus Sicherheits- oder Betriebsgründen.',
			'Das bloße Schließen eines Browserfensters oder Browser-Tabs kann technisch nicht in jedem Fall als zuverlässige Beendigung erkannt werden. Zur Feststellung der aktiven Nutzung setzt die Plattform deshalb einen serverseitigen Heartbeat in Verbindung mit einem definierten Inaktivitäts-Timeout ein.',
			'Die jeweils geltenden Abrechnungsregeln für Unterbrechungen, Inaktivität, Hintergrund-Tabs, Verbindungsabbrüche und die Wiederaufnahme einer Sitzung werden dem Anwender vor Beginn der kostenpflichtigen Sitzung verständlich und sichtbar angezeigt.',
			'Eine aufgrund eines technischen Fehlers nachweislich nicht nutzbare Zeit darf nicht als aktive Nutzungszeit berechnet werden.',
			'',
			'## 5.4 Modul-, Daten- und Rechengebühren',
			'Zusätzlich zu einer zeitabhängigen Basisgebühr können für einzelne Leistungen weitere nutzungsabhängige Gebühren anfallen. Dies betrifft insbesondere:',
			'- zusätzliche Plattformmodule;',
			'- Datenbankabfragen;',
			'- externe oder besondere Datenquellen;',
			'- rechenintensive Analysen und Simulationen;',
			'- Forecast- und Szenarioberechnungen;',
			'- Dokument-, Daten- und Grafikausgaben;',
			'- Exporte und Schnittstellenübertragungen;',
			'- besondere Beratungs-, Prüf- oder Assistenzleistungen.',
			'Vor der erstmaligen kostenpflichtigen Nutzung einer solchen Leistung werden mindestens der Preis, die Abrechnungseinheit, die Berechnungsgrundlage und – soweit vorgesehen – eine Kostengrenze angezeigt.',
			'Mehrkosten, die ein vereinbartes Sitzungs-, Nutzer-, Projekt-, Standort- oder Unternehmenskontingent überschreiten, dürfen nur nach einer ausdrücklichen Freigabe durch den Anwender oder eine hierzu berechtigte Stelle entstehen.',
			'Preisänderungen gelten nicht rückwirkend für bereits begonnene Sitzungen oder bereits ausdrücklich freigegebene Rechenaufträge. Für die Abrechnung ist die beim Beginn der jeweiligen Leistung gültige und angezeigte Preislisten- und Vertragsversion maßgeblich.',
			'Kostenpflichtige Folgevorgänge dürfen nicht allein dadurch ausgelöst werden, dass der Anwender eine vorherige Leistung aufgerufen oder bestätigt hat. Jede gesondert kostenpflichtige Leistung muss eindeutig erkennbar sein.',
			'',
			'## 5.5 Nutzungs- und Kostenprotokoll',
			'Nach jeder kostenpflichtigen Sitzung stellt die Plattform ein verständliches Nutzungs- und Kostenprotokoll bereit.',
			'Das Protokoll enthält mindestens:',
			'- die eindeutige Sitzungs-ID;',
			'- die Nutzer-, Mandanten-, Standort- oder Projektzuordnung;',
			'- Beginn und Ende der Sitzung;',
			'- registrierte Pausen und Unterbrechungen;',
			'- die abrechenbare aktive Nutzungsdauer;',
			'- die verwendeten Module und deren jeweilige Nutzungsdauer;',
			'- die verwendeten Filter, Parameter und Simulationsmerkmale;',
			'- Anzahl und Bezeichnung der angebundenen Datenquellen;',
			'- durchgeführte Datenbankabfragen und deren Ergebnisstatus;',
			'- ausgeführte Rechenaufträge mit Startzeit, Endzeit, Status und Rechenzeit;',
			'- erzeugte Forecast-Zeiträume, Szenarien und Ausgaben;',
			'- Einzelpreise und Abrechnungseinheiten;',
			'- Zwischensummen, Rabatte und angerechnete Kontingente;',
			'- die Gesamtsumme der Sitzung;',
			'- die verwendete Preislisten- und Vertragsversion;',
			'- Hinweise auf Fehler, Abbrüche, Stornierungen oder nicht berechnete Vorgänge.',
			'Das Nutzungs- und Kostenprotokoll ist innerhalb der Plattform einsehbar. Es wird zusätzlich als PDF-Dokument sowie in einem maschinenlesbaren Dateiformat zum Export bereitgestellt.',
			'Nachträgliche Berichtigungen dürfen bestehende Protokolle nicht unbemerkt überschreiben. Änderungen und Korrekturen werden versioniert, mit Zeitstempel versehen und nachvollziehbar dokumentiert. Die ursprüngliche Fassung bleibt entsprechend der geltenden Aufbewahrungs- und Nachweispflichten erhalten.',
			'',
			'## 5.6 Verantwortlichkeit für Simulationen und Ergebnisse',
			'Die von Liebherr Local Intelligence erzeugten Analysen, Simulationen, Prognosen und Handlungsvorschläge dienen der Informationsunterstützung. Sie ersetzen keine erforderliche fachliche, kaufmännische, technische, rechtliche oder unternehmerische Prüfung und Entscheidung.',
			'Vor einer produktiven Verwendung ist insbesondere zu prüfen, ob:',
			'- die verwendeten Ausgangsdaten vollständig und aktuell sind;',
			'- die gewählten Parameter dem tatsächlichen Anwendungsfall entsprechen;',
			'- alle relevanten regionalen und unternehmensinternen Vorgaben berücksichtigt wurden;',
			'- das Ergebnis durch eine hierzu berechtigte Person freigegeben wurde.',
			'Automatisch erzeugte Ergebnisse dürfen nicht ungeprüft als verbindliche Entscheidung, Zusage, Bestellung, Finanzierung, Kalkulation oder Vertragsgrundlage verwendet werden.',
			'',
			'## 5.7 Zugangsberechtigung und Sicherheit',
			'Der Zugang zur Plattform ist ausschließlich den jeweils autorisierten Personen gestattet. Zugangsdaten, Bestätigungscodes und sonstige Authentifizierungsmerkmale sind persönlich und vertraulich zu behandeln und dürfen nicht an andere Personen weitergegeben werden.',
			'Der Anwender ist verpflichtet, erkennbare Sicherheitsvorfälle, missbräuchliche Zugriffe, fehlerhafte Berechtigungen oder den Verdacht einer Kompromittierung unverzüglich an die zuständige Stelle zu melden.',
			'Bei einem begründeten Sicherheitsverdacht kann der Zugang vorübergehend eingeschränkt oder gesperrt werden. Eine solche Maßnahme dient dem Schutz der Plattform, der Unternehmensdaten und der angeschlossenen Systeme.',
			'',
			'## 5.8 Rechtlicher Freigabevorbehalt',
			'Diese Nutzungsbedingungen bilden die verbindliche Produkt-, Prozess- und Umsetzungsvorgabe für die technische Ausgestaltung von Liebherr Local Intelligence. Sie stellen jedoch noch keine abschließend rechtsgeprüfte Fassung Allgemeiner Geschäftsbedingungen dar.',
			'Vor Aufnahme des Produktivbetriebs sind insbesondere folgende Bereiche rechtlich und organisatorisch zu prüfen und ausdrücklich freizugeben:',
			'- Preisangaben und Abrechnungsmodelle;',
			'- Zustandekommen und Dokumentation kostenpflichtiger Verträge;',
			'- Speicherung und Zugriff auf Informationen im Endgerät;',
			'- Datenschutz, Informationssicherheit und Auftragsverarbeitung;',
			'- Einwilligungs- und Widerrufsprozesse;',
			'- Aufbewahrungs-, Nachweis- und Löschpflichten;',
			'- internationale und grenzüberschreitende Nutzung;',
			'- Verbraucher- und Unternehmensgeschäfte;',
			'- Haftung und Verantwortlichkeit für Simulationsergebnisse;',
			'- arbeitsrechtliche und unternehmensinterne Mitbestimmungsrechte;',
			'- Export-, Geheimhaltungs- und Compliance-Anforderungen.',
			'Der Produktivbetrieb darf erst aufgenommen werden, nachdem die zuständigen rechtlichen, datenschutzrechtlichen, sicherheitstechnischen und unternehmerischen Stellen die endgültige Fassung freigegeben haben.',
		] );
	}
	...
	public static function defaults(): array {
		return [
			...
			'intro' => [
				...
				'terms_heading'      => __( 'Erweiterte Nutzungsbedingungen für Liebherr Local Intelligence', 'liebherr-interface-world' ),
				'terms_body'         => self::default_terms(),
