	...
	public static function maybe_enqueue(): void {
		...
		wp_localize_script( self::HANDLE, 'liwAdv', [
			...
			'i18n'      => [
				...
				'uploading'  => __( 'Wird hochgeladen …', 'liebherr-interface-world' ),
				'uploaded'   => __( 'Bild hochgeladen', 'liebherr-interface-world' ),
				'uploadErr'  => __( 'Upload fehlgeschlagen', 'liebherr-interface-world' ),
