...
- **S14 · MYL-ADV Drei-Wort-Name. ⚠️ TEIL (alpha.121)** — Drei-Wort-Titel in My Dreams (`ContentRules::three_words`); volles normalisiertes Label-System + Synonyme im Index offen. Muster Maschine-Problem-Handlung, genau drei normalisierte Begriffe, Synonyme/Übersetzungen im Index. *DB:* `ary_liw_myl_three_word_label`. *Abnahme:* MYL 017.
